		...
		<div id="content" class="withsidebar">
        	<div id="main">
            	<div id="maincontent">
                    ...
                    <p>Proin sed sem ante. Integer lacus orci, lacinia blandit euismod sed, sagittis et magna. Pellentesque gravida fermentum pulvinar. <span class="colortext">Cras id convallis urna.</span> Fusce eget leo quis tellus blandit porta. Mauris porta facilisis lacus, a ultricies lacus sagittis a. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. </p>
                      ...
                      <form id="contact" action="#">
                        <fieldset>
                         ...
                         <textarea cols="60" rows="10" name="msg" id="msg" ></textarea> <br class="clear" />
                          <input type="submit" name="submit" class="butcontact" id="submit_btn" value="Submit"/>
                        </fieldset>
                      </form>
                      <br class="clear" />
                ...
                <div id="sidebar">
                	<ul>
                    	<li class="widget-container">
                           ...
                           <p> Magnum - Office Blvd No. 356-357<br/>
                            Farmville Town, LA 12345</p>
                            <p>
                            Telp: +62 500 800 123<br/>
                            Fax: +62 500 800 112<br/>
                            Email: <a href="mailto:testmail@yourdomain.com" class="colortext">testmail@yourdomain.com</a><br/>
                            Website: <a href="http://www.templatesquare.com" class="colortext">www.templatesquare.com</a><br/>
                            </p>
                            </div>
                        </li>
                    	<li class="widget-container">
