    	...
    	<div id="top">
            ...
            <div id="nav">
                <ul id="topnav" class="sf-menu">
                    ...
                    <li><a href="product.php" class="current">商品</a>
                        <ul>
        	...
        	<div id="main">
            	<div id="maincontent">
                     ...
                     <ul id="ts-display-product">
                        <li>
                            <div class="ts-display-product-img">
                               <a href="single-product.php"> <img src="images/content/product/prod1.jpg" alt="" /></a>
                            </div>
                            <div class="ts-display-product-text">
                            <h2 class="colortext">Toshiba Laptop 24’</h2>
                            <span class="productprice">$ 870.00</span>
                            <a href="single-product.php" class="button">Add to Cart</a>
                            </div>
                        </li>
                        <li>
                            <div class="ts-display-product-img">
                               <a href="single-product.php"> <img src="images/content/product/prod2.jpg" alt="" /></a>
                            </div>
                            <div class="ts-display-product-text">
                            <h2 class="colortext">Keyboard Vista</h2>
                        ...
                        <li class="nomargin">
                            <div class="ts-display-product-img">
                               <a href="single-product.php"> <img src="images/content/product/prod3.jpg" alt="" /></a>
                            </div>
                            <div class="ts-display-product-text">
                            <h2 class="colortext">Scanner and Printer</h2>
                        ...
                        <li>
                            <div class="ts-display-product-img">
                               <a href="single-product.php"> <img src="images/content/product/prod4.jpg" alt="" /></a>
                            </div>
                            <div class="ts-display-product-text">
                            <h2 class="colortext">HD - Apple</h2>
                        ...
                        <li>
                            <div class="ts-display-product-img">
                               <a href="single-product.php"> <img src="images/content/product/prod5.jpg" alt="" /></a>
                            </div>
                            <div class="ts-display-product-text">
                            <h2 class="colortext">iPad- Apple</h2>
                        ...
                        <li class="nomargin">
                            <div class="ts-display-product-img">
                               <a href="single-product.php"> <img src="images/content/product/prod6.jpg" alt="" /></a>
                            </div>
                            <div class="ts-display-product-text">
                            <h2 class="colortext">Nokia N8</h2>
                        ...
                        <li>
                            <div class="ts-display-product-img">
                               <a href="single-product.php"> <img src="images/content/product/prod7.jpg" alt="" /></a>
                            </div>
                            <div class="ts-display-product-text">
                            <h2 class="colortext">Mouse Track</h2>
                        ...
                        <li>
                            <div class="ts-display-product-img">
                               <a href="single-product.php"> <img src="images/content/product/prod8.jpg" alt="" /></a>
                            </div>
                            <div class="ts-display-product-text">
                            <h2 class="colortext">Headphone - Sony</h2>
                        ...
                        <li class="nomargin">
                            <div class="ts-display-product-img">
                               <a href="single-product.php"> <img src="images/content/product/prod9.jpg" alt="" /></a>
                            </div>
                            <div class="ts-display-product-text">
                            <h2 class="colortext">PSP 3D - Sony</h2>
                     ...
                     <div class="pagenavi productnav">
                        <a href="" class="page">1</a><span class="current">2</span><a href="" class="page">3</a><a href="" class="nextpostslink">Next &raquo;</a>
                    </div><!-- end pagenavi -->

                     <form class="prod_ordering" method="post">
                        <select name="catalog_orderby" class="orderby">
                            <option value="title"  selected='selected'>Alphabetically</option><option value="date" >Most Recent</option><option value="price" >Price</option>			</select>
                    </form>
                	...
                	<ul>
                    	<li class="widget-container">
                            ...
                            <ul id="shoppingcartwidget">
                                <li>
                                    <a href="#"><img src="images/content/product/lp4.jpg" alt="" class="alignleft" /></a>
                                    <span class="colortext">New Printer XP</span><br/>
                                    <span>1x  $ 950.00</span>
                                    <span class="clear"></span>
                                </li>
                                <li>
                                    <a href="#"><img src="images/content/product/lp5.jpg" alt="" class="alignleft" /></a>
                                    <span class="colortext">New Camera Digital 16MP</span><br/>
                                    <span>1x  $ 550.00</span>
                                    <span class="clear"></span>
                                </li>
                            </ul>
                    	...
                    	<li class="widget-container">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Computer (20)</a></li>
                                <li><a href="#">Handphone (30)</a></li>
                    	...
                    	<li class="widget-container">
                            ...
                            <ul id="recentproductwidget">
                                <li>
                                    <a href="#"><img src="images/content/product/lp1.jpg" alt="" class="alignleft" /></a>
                                    <span class="colortext">Sony Camera 13MP</span><br/>
                                    <span>$ 350.00</span>
                                    <span class="clear"></span>
                                </li>
                                <li>
                                    <a href="#"><img src="images/content/product/lp2.jpg" alt="" class="alignleft" /></a>
                                    <span class="colortext">Samsung Captivate</span><br/>
                                    <span>$ 550.00</span>
                                    <span class="clear"></span>
                                </li>
                                <li>
                                    <a href="#"><img src="images/content/product/lp3.jpg" alt="" class="alignleft" /></a>
                                    <span class="colortext">iPod Touch</span><br/>
                                    <span>$ 120.00</span>
                                    <span class="clear"></span>
                                </li>
                            </ul>
